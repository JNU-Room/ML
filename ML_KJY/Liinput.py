...
from pylib.New_LenearRegression import LenearRegression


sess = tf.Session()

x_data_dic = [[1,2,3,4,5],[2,3,4],[4,5,6]]
...
x_data = [[2,4,5],[3,2,4],[1,3,5],[5,3,6]]
y_data = [[2],[3],[4],[5]]
...
test = LenearRegression(x_data, y_data,x_data_dic)
